...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'BlogSetting'
        db.create_table(u'blogextras_blogsetting', (
        ...
        db.send_create_signal(u'blogextras', ['BlogSetting'])


    def backwards(self, orm):
        # Deleting model 'BlogSetting'
        db.delete_table(u'blogextras_blogsetting')
    ...
    models = {
        ...
        u'blogextras.blogsetting': {
            'Meta': {'object_name': 'BlogSetting'},
            'blog_post': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['blog.BlogPost']", 'unique': 'True'}),
